                  ...
                  SELECT MAJOR,
                        ...
                        CASE
                         ...
                         CASE
                            ...
                            START,
                         CASE WHEN DATEDIFF(YEAR, START, '2025-01-01') >= 2 THEN 1
                            ELSE 0 END AS TWO_YEARS_PASSED,
                        CASE WHEN DATEDIFF(YEAR, START, '2025-01-01') >= 4 THEN 1
                            ELSE 0 END AS FOUR_YEARS_PASSED,
                       CASE WHEN DATEDIFF(YEAR, START, '2025-01-01') >= 6 THEN 1
                            ELSE 0 END AS SIX_YEARS_PASSED
                  FROM (
--(Begin C1)------------------------------------------------------------------------------------------------------------
                           SELECT X.MAJOR,
                                  X.STUDENT_ID,
