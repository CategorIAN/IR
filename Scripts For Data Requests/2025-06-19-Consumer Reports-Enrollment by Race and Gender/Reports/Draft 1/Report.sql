...
SELECT GENDER,
       ...
       [Full-Time],
       [Part-Time],
       [Full-Time] + [Part-Time] AS GRAND_TOTAL
FROM (
--(Begin 2)------------------------------------------------------------------------------------------------------------
         SELECT STUDENT_ID,
...
--(Begin 1)------------------------------------------------------------------------------------------------------------
                  ...
                  FROM STUDENT_ENROLLMENT_VIEW AS SEV
                           ...
                           LEFT JOIN (VALUES ('6188731', 'F'),
                                             ...
                                             ('6189318', 'M'),
                                             ('6189252', 'M'),
                                             ('6187468', 'M')) AS ADJUSTED_GENDER(ID, X)
                                     ON ADJUSTED_GENDER.ID = STUDENT_ID
...
--(End 2)---------------------------------------------------------------------------------------------------------------
     ) AS X PIVOT (COUNT(STUDENT_ID) FOR LOAD IN (
        [Full-Time],
       [Part-Time]
        )) AS X
--(End 3)---------------------------------------------------------------------------------------------------------------
