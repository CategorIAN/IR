...
--(Begin 1)--------------------------------------------------------------------------------------
         SELECT STUDENTS.STUDENT_ID,
                ...
                CASE WHEN DF.TERM IS NULL THEN 'Not Pell' ELSE 'Pell' END AS PELL_STATUS
         FROM (SELECT DISTINCT TERMS.TERMS_ID AS TERM,
               ...
               WHERE TERMS.TERM_START_DATE >= '2019-08-01'
                 ...
                 AND MAJORS.MAJ_DESC = 'Master of Social Work') AS STUDENTS
                  ...
                  LEFT JOIN (VALUES ('2019FA', '5225825'),
                                                       ('2020SP', '5225825'),
                                                       ('2019FA', '5233269'),
                                                       ('2020SP', '5233269'),
                                                       ('2019FA', '5240259'),
                                                       ...
                                                       ('2024FA', '6189482'),
                                                       ('2025SP', '6189482'))
         AS DF(TERM, STUDENT_ID) ON SEV.ENROLL_TERM = DF.TERM AND SEV.STUDENT_ID = DF.STUDENT_ID
         WHERE ENROLL_CURRENT_STATUS IN ('New', 'Add')
--(End 1)--------------------------------------------------------------------------------------------------------------
     ) AS X
PIVOT (COUNT(STUDENT_ID) FOR PELL_STATUS IN ([Not Pell], [Pell])) AS X
--(End 2)--------------------------------------------------------------------------------------------------------------