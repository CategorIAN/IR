...
FROM
    (SELECT PERSTAT_HRP_ID,
            ...
            PERSTAT_TENURE_TYPE,
            CASE
                WHEN FOR_CREDIT.FACULTY_ID IS NOT NULL AND NOT_FOR_CREDIT.FACULTY_ID IS NULL THEN 'Exclusively_Credit'
                WHEN FOR_CREDIT.FACULTY_ID IS NULL AND NOT_FOR_CREDIT.FACULTY_ID IS NOT NULL THEN 'Exclusively_Not_Credit'
                ELSE 'Combined_Credit_Not_Credit'
                END AS PRIMARILY_INSTRUCTION
     ...
     GROUP BY PERSTAT_HRP_ID,
              ...
              NOT_FOR_CREDIT.FACULTY_ID
     ) AS X
GROUP BY PRIMARILY_INSTRUCTION, PERSTAT_TENURE_TYPE