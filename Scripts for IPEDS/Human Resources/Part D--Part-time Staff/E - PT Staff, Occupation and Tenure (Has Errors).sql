...
-----------------------------------------------------------------------------------------------------------------------
                ...
                CASE
                WHEN POS_CLASS = 'FAC' THEN
                    CASE WHEN (PERSTAT_TENURE_TYPE = 'N' OR PERSTAT_TENURE_TYPE IS NULL) THEN 'N'
                    ELSE PERSTAT_TENURE_TYPE END
                ELSE 'Without Faculty Status' END AS TENURE_STATUS
...
PIVOT (COUNT(ID) FOR TENURE_STATUS IN ([T],
       [O],
       [N],
...
-----------------------------------------------------------------------------------------------------------------------
                ...
                CASE
                WHEN POS_CLASS = 'FAC' THEN
                    CASE WHEN (PERSTAT_TENURE_TYPE = 'N' OR PERSTAT_TENURE_TYPE IS NULL) THEN 'Annual Contract'
                    ELSE PERSTAT_TENURE_TYPE END
                ELSE 'Without Faculty Status' END AS TENURE_STATUS
