...
PIVOT (COUNT(ID) FOR IPEDS_OCCUPATION_CATEGORY IN ([Management Occupations],
       [Business and Financial Operations Occupations],
       [Computer, Engineering, and Science Occupations],
       [Community, Social Service, Legal, Arts, Design, Entertainment, Sports, and Media Occupations],
       [Healthcare Practitioners and Technical Occupations])) AS Y --Men
-----------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------
SELECT RACE,
       [Management Occupations],
...
PIVOT (COUNT(ID) FOR IPEDS_OCCUPATION_CATEGORY IN ([Management Occupations],
       ...
       [Computer, Engineering, and Science Occupations],
       [Community, Social Service, Legal, Arts, Design, Entertainment, Sports, and Media Occupations],
       [Healthcare Practitioners and Technical Occupations])) AS Y --Women
...
-----------------------------------------------------------------------------------------------------------------------
      ...
      WHERE PERSTAT_END_DATE IS NULL
        ...
        AND POS_TITLE NOT LIKE '%Announcer%'
        AND POS_TITLE NOT LIKE '%Administrative Assistant%'
        AND GENDER IS NULL) AS X

PIVOT (COUNT(ID) FOR IPEDS_OCCUPATION_CATEGORY IN ([Management Occupations],
       [Business and Financial Operations Occupations],
       [Computer, Engineering, and Science Occupations],
       [Community, Social Service, Legal, Arts, Design, Entertainment, Sports, and Media Occupations],
       [Healthcare Practitioners and Technical Occupations])) AS Y --Unknown Gender

SELECT * FROM PERSON WHERE ID = '6189498'