...
PIVOT (COUNT(ID) FOR IPEDS_OCCUPATION_CATEGORY IN ([Archivists, Curators, and Museum Technicians],
       [Librarians and Media Collections Specialists],
       [Library Technicians],
       [Student and Academic Affairs and Other Education Services Occupations])) AS Y --Men
-----------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------
SELECT RACE,
       [Archivists, Curators, and Museum Technicians],
...
PIVOT (COUNT(ID) FOR IPEDS_OCCUPATION_CATEGORY IN ([Archivists, Curators, and Museum Technicians],
       [Librarians and Media Collections Specialists],
       [Library Technicians],
       [Student and Academic Affairs and Other Education Services Occupations])) AS Y --Women