...
SELECT STTR_STUDENT,
        ...
        CASE
            WHEN STP_PROGRAM_TITLE = 'Non-Degree Seeking Students' THEN 'Non-Degree Seeking'
            WHEN UED.CURRENT_START_TERM = '2024FA' THEN CASE
                WHEN UED.CURRENT_ADMIT_STATUS = 'FY' OR UED.CURRENT_ADMIT_STATUS IS NULL THEN 'First-time'
                ELSE 'Transfer-in' END
            ELSE 'Continuing/Returning' END AS STATUS
